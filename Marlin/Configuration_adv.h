...
#define LIN_ADVANCE
    ...
    #define ADVANCE_K { 0.125 }    // 0.22 (mm) Compression length per 1mm/s extruder speed, per extruder
  #else
...
/* todo: merge conflict bugfix2.1
*/
  #if AXIS_IS_TMC_CONFIG(X)
    #define X_CURRENT       800        // (mA) RMS current. Multiply by 1.414 for peak current.
    #define X_CURRENT_HOME  X_CURRENT  // (mA) RMS current for sensorless homing
/* todo: merge conflict bugfix2.1 - from 2.0
  #if AXIS_IS_TMC(X)
