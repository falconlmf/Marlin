...
#define CUSTOM_MACHINE_NAME "Ender-3 Pro CR r0310"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 97.9 } // { 80, 80, 400, 93 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -45, -7, -1.33 } // { -45, -7, 0 }
...
#define HOMING_FEEDRATE_MM_M { (130*60), (130*60), (15*60) }
